...
from app.database import pyramid, user, knb, payment
...
# scheduler.add_job(pyramid.update_reserve_and_balance, 'cron', hour=23, minute=59, second=59)

scheduler.add_job(pyramid.update_reserve_and_balance, 'interval', hours=2)
